...
def notification_dedupe_key(employee_id: str, message: str, day: date) -> str:
    """The same message to the same employee on the same day is one notification."""
    return _sha256(canonical_json([employee_id, " ".join(message.split()), day.isoformat()]))
